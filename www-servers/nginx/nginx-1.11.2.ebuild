...
mod_p["auth_pam"]="${mod_pn["auth_pam"]}-${mod_sha["auth_pam"]}"
mod_uri["auth_pam"]="https://github.com/${mod_a["auth_pam"]}/${mod_pn["auth_pam"]}/archive/${mod_sha["auth_pam"]}.tar.gz"
...
mod_pv["echo"]="0.58"
mod_sha["echo"]="02c40f140a6cf1c63478e4175322c91a8bc206e3"
mod_lic["echo"]="BSD-2"
...
# Bug https://bitbucket.org/bronaCZ/nginx-sticky-module-ng/commits/1878f0d9ede460c870b3ee9011e50fd0c9c925fb?at=master#Lngx_http_sticky_misc.cF88
